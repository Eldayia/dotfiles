...

{
  ...
  echo ""
  echo "--- Test de lancement kitty (version) ---"
  kitty --version 2>&1 || echo "kitty command failed"
  echo ""
  echo "--- Tentative de lancement kitty avec logs ---"
  timeout 3 kitty 2>&1 || echo "kitty failed to launch window"
  echo ""
  echo "--- Tentative de lancement xterm avec logs ---"
  timeout 3 xterm 2>&1 || echo "xterm failed to launch window"
  echo ""
  echo "--- PATH ---"
  echo "$PATH"
  echo ""
